...
<head>
  ...
  <title>ariaflow</title>
    ...
    :root[data-theme="light"] {
      ...
      --panel-2: rgba(250, 244, 236, 0.94);
      --line: rgba(120, 98, 72, 0.16);
      --text: #1f2937;
      --muted: #645749;
      --accent: #0f766e;
      --accent-2: #c2410c;
      --warn: #b45309;
      --danger: #b91c1c;
      --shadow: 0 18px 44px rgba(120, 98, 72, 0.12);
    }
    * { box-sizing: border-box; }
    ...
    :root[data-theme="light"] .metric {
      background: linear-gradient(180deg, rgba(255, 250, 244, 0.98), rgba(246, 237, 226, 0.96));
    }
        ...
        <div class="panel toolbar">
          <div class="queue-add-row">
            <div class="queue-add-group">
              ...
              <button class="secondary queue-add-button" onclick="add()">Add</button>
            </div>
          </div>
        </div>
      </div>
