...
Sources:
  - pyproject.toml
  - src/ariaflow_web/webapp.py
  - src/ariaflow_web/static/{app.js,index.html}
...
def render() -> str:
    ...
    add("# Project Specification — ariaflow-web")
    add("")
    add(
    ...
    add(
        ...
        "`src/ariaflow_web/static/app.js`."
    )
    add("")
