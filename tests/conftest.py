    ...
    "items": [
        {
            ...
            "files": [{"path": "/downloads/big.iso", "length": 104857600}],
        ...
        },
        {
            ...
            "gid": "bbb222",
            "priority": 1,
            "files": [{"path": "/downloads/small.zip", "length": 1024}],
            "created_at": "2026-04-01T10:01:00",
        },
        {
            "id": "item-3",
            "url": "https://example.com/done.tar",
            "output": "done.tar",
            "status": "done",
            "gid": "ccc333",
            "priority": 2,
            ...
            "files": [{"path": "/downloads/done.tar", "length": 2048}],
        ...
        },
        {
            ...
            "files": [{"path": "/downloads/fail.bin", "length": 4096}],
            "created_at": "2026-04-01T09:30:00",
        },
        {
            "id": "item-5",
            "url": "https://example.com/paused.dat",
            "output": "paused.dat",
            "status": "paused",
            "gid": "eee555",
            "priority": 4,
            "recovered": False,
            "files": [{"path": "/downloads/paused.dat", "length": 8192}],
